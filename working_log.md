...
**Time** : ทำช่วงเวลาประมาณ 2.5 ชั่วโมง (9:00 - 11:30)
  #### อ่านและทำความเข้าใจโจทย์ส่วนแรก Assembly language และ assembler
    - ทำความเข้าใจโจทย์ก่อน ว่าต้องการอะไร ทำความเข้าใจหลักการทำงานของassembly codeในตัวอย่าง
    - ได้ไอเดียคร่าวๆว่าจะใช้หลักการGrammars and Parsingที่เคยเรียนในวิชาOOPมาปรับใช้
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 5 ชั่วโมง (8:00 - 11:00,15:00 - 17:00)
  #### ศึกษาเพิ่มเติมในหลักการที่จะนำมาประยุกต์ใช้
    - ทบทวนและศึกษาเพิ่มเติมเกี่ยวกับparserเนื่องจากไม่ได้นำมาใช้นานแล้วจึงลืม
    - วางโครงคร่าวๆ ว่าโปรแกรมแปลงassemblyเป็นmachine codeนี้ควรมีโครงสร้างอย่างไรบ้าง
  #### หาวิธีแยก label,instruction,fieldออกเป็นคำๆ โดยใช้tokenizer
    - แบ่งประเภทคำสั่งกับจำนวนfieldที่ต้องการ grammarของภาษา
    - สร้างgrammar typeมาเท่าที่จำเป็น จะได้ทำเป็น Abstract syntax treeได้
  #### ทำการimplement tokenizerเบื้องต้น
    - ทำให้สามารถแยกคำออกมาได้และตัดส่วนของคอมเมนต์ออกได้
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 4 ชั่วโมง (13:00 - 17.00)
  #### ออกแบบและimplementส่วนของ Parser
    - ทำให้parserสามารถสร้างabstract syntax treeขึ้นมาได้ ถูกต้องตามลำดับ
    - ทำให้ parse คำที่มาจาก tokenizerได้อย่างถูกต้อง แต่ยังประมวลผลออกมาป็นmachine codeไม่ได้
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 2 ชั่วโมง (19:00 - 21:00)
  #### ทำให้ Parser evaluateค่าออกมาเป็นmachine codeได้
    - implementฟังชันการeavluateค่าของแต่ละgrammar type
    - ทำการแปลงค่าต่างๆให้เป็นbinary stringแล้วเอามาต่อกันตามรูปแบบของคำสั่งแต่ละtype
    - ทำการแปลงกลับเป็นจำนวนเต็มแล้วส่งไปเก็บในmemory
_____________________________________________________________________________
...
**Time** : ประมาณ 1.5 ชั่วโมง (10:15 - 10:45, 13:30 - 14:30)
  #### แก้ไข simulator ให้ print output ลงใน file
    - ปรับให้ simulator print output ไปที่ไฟล์แทน terminal และะสร้าง only pc printer 
    สำหัรบ debug สะดวกขึ้น
_____________________________________________________________________________
...
**Time** : ประมาณ 3 ชั่วโมง (14:00 - 17:00)
  #### ทำ combination เสร็จแล้ว
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 3 ชั่วโมง 30 นาที (19:30 - 23:00)
  #### ศึกษา การเขียนภาษา Assembly
    - นั่งดูคลิปเพื่อศึกษาการเขียน Assembly และลอง เขียน เพื่อทบทวนความจำนิดหน่อย
...
**Time** : ประมาณ 4 ชั่วโมง (16:00 - 17:00, 19:00 - 22:00)
  #### สร้างตัวแปร numMemory
    - numMemory จะเก็บจำนวนบรรทัดของ memory ที่ใช้ ทั้ง instructions และ data
    - ซึ่งจะใส่ค่าไปพร้อมกับตอนสร้าง simulator
    - โดย printer จะ print เฉพาะบรรทัดที่ใช้จริงๆ ซึ่งรวมไปถึงการทำ stack ด้วย

  #### ใส่ comments และ documentations
    - เพิ่มคอมเม้นต่างๆ ในทุก classes ให้ได้มากที่สุด และเข้าใจง่ายขึ้น
    - รวมถึง documentation สำหรับ functions ต่างๆ
    - ลบ code หรือ params บางส่วนที่ใช้สำหรับการ test เล็กๆน้อยๆ
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 3 ชั่วโมง (12:00 - 15:00)
  #### ศึกษา การ Multiplication จากของเพื่อน เพื่อทำยกกำลัง
    - ลองศึกษาMultiplicationก่อนที่จะเขียนลง assembly
    - ทำความเข้าใจ 
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 4 ชั่วโมง (19:00 - 23:00)
  #### ลงมือทำ Exponential 
    - ออกแบบ และเขียน assembly ได้เเล้ว แต่ติด bug นิดหน่อยทำได้ประมาณ 80 %
    - มีปัญหาเรื่องตัวแปรที่จำกัดนิดหน่อย
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 1 ชั่วโมง 30 นาที (13:00 - 14:30)
  #### ทำ Exponential เสร็จแล้ว 
    - ปรึกษากับเพื่อนอีกคนที่ทำแล้วแก้โครงนิดหน่อย
_____________________________________________________________________________
...
**Time** : ทำช่วงเวลาประมาณ 1 ชั่วโมง (22:00 - 23:00)
  #### แก้ไข Parser
    - เนื่องจากตอนแรก Parser รับinputเป็น String ที่่เป็นassembly codeยาวๆเลย ได้ทำการปรับเป็นรับเป็นชื่อไฟลล์ที่มีข้อมูลเป็นassembly code
    - ลบbindingออกจากconstructorเนื่องจากไม่จำเป็นต้องส่งมาจากภายนอกและไม่ได้จำเป็นต้องเอาออกไปใช้ เลยสร้างไว้แค่ในคลาสParser
    - สร้างไฟลล์ assembly_code.txt ไว้บรรจุassembly codeที่ต้องการ
_____________________________________________________________________________